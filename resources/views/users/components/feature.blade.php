  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 mx-auto text-center">
        ...
        <h3 class="display-3">Fitur Unggulan desajuara.com</h3>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="info text-center">
          ...
          <h6 class="info-title text-uppercase text-success">Informasi Desa</h6>
      ...
      <div class="col-md-4">
        <div class="info text-center">
          ...
          <h6 class="info-title text-uppercase text-warning">Peta Bidang Desa</h6>
