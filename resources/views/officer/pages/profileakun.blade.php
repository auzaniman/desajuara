          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input class="form-control" type="text" value="{{$officer->username}}">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="example-text-input" class="form-control-label">Email address</label>
                <input class="form-control" type="email" value="{{$officer->email}}">
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input class="form-control" type="text" value="{{$officer->nik}}">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="example-text-input" class="form-control-label">No KK</label>
                <input class="form-control" type="text" value="{{$officer->kk}}">
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input class="form-control" type="text" value="{{$officer->name}}">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="example-text-input" class="form-control-label">Tempat Tanggal Lahir</label>
                <input class="form-control" type="text" value="{{$officer->ttl}}">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="example-text-input" class="form-control-label">Jenis Kelamin</label>
                <input class="form-control" type="text" value="{{$officer->kelamin}}">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="example-text-input" class="form-control-label">Agama</label>
                <input class="form-control" type="text" value="{{$officer->agama}}">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="example-text-input" class="form-control-label">Status Perkawinan</label>
                <input class="form-control" type="text" value="{{$officer->perkawinan}}">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="example-text-input" class="form-control-label">Kewarganegaraan</label>
                <input class="form-control" type="text" value="{{$officer->kewarganegaraan}}">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="example-text-input" class="form-control-label">Pekerjaan</label>
                <input class="form-control" type="text" value="{{$officer->pekerjaan}}">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="example-text-input" class="form-control-label">Pendidikan</label>
                <input class="form-control" type="text" value="{{$officer->pendidikan}}">
              </div>
            </div>
          </div>
          <hr class="horizontal dark">
      ...
      <div class="card-body pt-0">
        ...
        <div class="text-center mt-4">
          <div class="h6 font-weight-300">
            <i class="ni location_pin mr-2"></i>{{$officer->kota}}, {{$officer->kecamatan}}
          </div>
          <div class="h6 mt-4">
            <i class="ni business_briefcase-24 mr-2"></i>{{$officer->pekerjaan}}
          </div>
          <div>
            <i class="ni education_hat mr-2"></i>{{$officer->pendidikan}}
          </div>
        </div>
      </div>
    </div>
