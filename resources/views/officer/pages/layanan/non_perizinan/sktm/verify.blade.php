        ...
        <ul class="list-group">
          <li class="list-group-item border-0 p-4 mb-2 bg-gray-100 border-radius-lg">
            <div class="d-flex flex-column mb-3">
              ...
              <span class="mb-2">NIK: <span class="text-dark ms-sm-2 font-weight-bold">{{$sktm->nik_pemohon}}</span></span>
              <span class="mb-2">No KK: <span class="text-dark ms-sm-2 font-weight-bold">{{$sktm->kk_pemohon}}</span></span>
              <span class="mb-2">Alamat: <span class="text-dark ms-sm-2 font-weight-bold">{{$sktm->alamat_pemohon}}</span></span>
              <span class="mb-2">Email Address: <span class="text-dark ms-sm-2 font-weight-bold">{{$sktm->email_pemohon}}</span></span>
              <span class="mb-2">No Telpon: <span class="text-dark ms-sm-2 font-weight-bold">{{$sktm->hp_pemohon}}</span></span>
            </div>
